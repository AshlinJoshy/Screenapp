...
| ID | Test | How | Status | Fix / Notes |
|----|------|-----|--------|-------------|
| CR-001 | Advertiser requests upload URL for image → 200 + presigned URL | Vitest | 🔄 Pending | |
| CR-002 | Advertiser requests upload URL for video → 200 | Vitest | 🔄 Pending | |
| CR-003 | Owner cannot request upload URL → 403 | Vitest | 🔄 Pending | |
| CR-004 | Confirm upload → creative status becomes 'processing' | Vitest | 🔄 Pending | |
| CR-005 | Delete creative not in active campaign → 200 | Vitest | 🔄 Pending | |
| CP-001 | Create campaign with valid data → 201 | Vitest | 🔄 Pending | |
| CP-002 | Create ad group within campaign → 201 | Vitest | 🔄 Pending | |
| CP-003 | Add ad (creative) to ad group → 201 | Vitest | 🔄 Pending | |
| CP-004 | A/B test: add 2 ads to same group with different weights | Vitest | 🔄 Pending | |
| CP-005 | Submit ad group for approval → approval records created | Vitest | 🔄 Pending | |
...
| ID | Test | How | Status | Fix / Notes |
|----|------|-----|--------|-------------|
| AP-001 | Owner sees pending approvals for their screens | Vitest | 🔄 Pending | |
| AP-002 | Owner approves ad group → playlist regenerated | Vitest | 🔄 Pending | |
| AP-003 | Owner rejects ad group → status = rejected | Vitest | 🔄 Pending | |
| AP-004 | Other owner cannot see/action approvals for another's screen | Vitest | 🔄 Pending | |
| PL-001 | Player with valid API key fetches playlist → 200 + JSON | Vitest | 🔄 Pending | |
| PL-002 | Player with invalid API key → 401 | Vitest | 🔄 Pending | |
| PL-003 | Player sends heartbeat → screen status = online | Vitest | 🔄 Pending | |
| PL-004 | Playlist contains only approved ads | Vitest | 🔄 Pending | |
...
| M-003 | Image ad displays for correct duration | Manual + stopwatch | 🔄 Pending | |
...
| Last full run | 2026-04-09 — **57/57 PASS** |
